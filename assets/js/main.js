function checklogin() {
    ...
    if (x == null || x == "null") {
        ...
        userslist();
        document.getElementById("chat-box").scrollTo(0, document.getElementById("chat-box").clientHeight);
        ...
        if (snapshot.exists()) {
            ...
            snapshot.forEach(function(data) {
                ...
                if (val.email == email) {
                    ...
                    content += '<li onclick="selectuser(this)" style="list-style-type: none;display:block;margin-left:65px;margin-top:-10px">' + val.email + '</li>';
                    content += '<hr>'
                    content += '</ul>';
                }
